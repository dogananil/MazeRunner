...
namespace Packages.ServiceLocator
{
    public class ServiceLocatorManager
    {
        ...
        public void Register<T>(ServiceLocatorPrefab serviceInstance,bool destroyOnLoad = false)
        {
            ...
            if (serviceInstance.OnNetwork)
            {
                /*NetworkRunner networkRunner = Resolve<NetworkRunner>();
                if (networkRunner != null && networkRunner.IsServer)
                {
                    networkRunner.Spawn(serviceInstance.ObjectToInstantiate);
                    return;
                }
        ...
        // public static T AsMonoNetworked<T>(bool destroyOnLoad = false) where T : Component
        // {
        //     NetworkRunner networkRunner = ServiceLocatorManager.Instance.Resolve<NetworkRunner>();
        //     if (networkRunner == null)
        //         return null;
        //
        //     GameObject gameObject = Resources.Load<GameObject>("BaseCastleNetworkObject");
        //     var obj = gameObject.AddComponent<T>();
        //     if (!destroyOnLoad)
        //     {
        //         Object.DontDestroyOnLoad(gameObject);
